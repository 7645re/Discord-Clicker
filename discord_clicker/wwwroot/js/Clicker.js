...
function intervalAutoSave(interval) {
    setInterval(async () => {
        if (true) {
            ...
            alert.innerHTML = `<div class="alert" role="alert">
                          <div class="autosave-img">
                          ...
                          <div class="autosave-text">AutoSave</div>
                          <div class="autosave-discord-img"><img width="20" src="https://pnggrid.com/wp-content/uploads/2021/05/Black-and-white-Discord-Logo-1024x784.png"/></div>
                          <div class="autosave-money">${result["money"] == undefined ? result["reason"] : result["money"] }</div>
                        </div>`
